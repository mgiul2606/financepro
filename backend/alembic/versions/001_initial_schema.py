...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('goal_type', postgresql.ENUM('house', 'car', 'vacation', 'retirement', 'emergency_fund', 'education', 'investment', 'custom', name='goaltype', create_type=False), nullable=False),
        ...
        sa.Column('status', postgresql.ENUM('active', 'paused', 'completed', 'cancelled', name='goalstatus', create_type=False), nullable=False, server_default='active'),
