...
export const importCsvApiV1ImportsPost = async (
  ...
  formData.append(`profileId`, bodyImportCsvApiV1ImportsPost.profileId);
  if (
    bodyImportCsvApiV1ImportsPost.accountId !== undefined &&
    bodyImportCsvApiV1ImportsPost.accountId !== null
  ) {
    formData.append(`accountId`, bodyImportCsvApiV1ImportsPost.accountId);
  }
  if (
  ...
  if (bodyImportCsvApiV1ImportsPost.skipDuplicates !== undefined) {
    formData.append(
      `skipDuplicates`,
      bodyImportCsvApiV1ImportsPost.skipDuplicates.toString(),
    );
  }
  if (
    bodyImportCsvApiV1ImportsPost.userPassword !== undefined &&
    bodyImportCsvApiV1ImportsPost.userPassword !== null
  ) {
    formData.append(`userPassword`, bodyImportCsvApiV1ImportsPost.userPassword);
  }
...
> => {
  return useMutation(
    getImportCsvApiV1ImportsPostMutationOptions(options),
    queryClient,
  );
};
/**
