...
export const createTransactionApiV1TransactionsPostBodySourceDefault = `manual`;
...
export const CreateTransactionApiV1TransactionsPostBody = zod
  .object({
    ...
    source: zod
      ...
      .default(createTransactionApiV1TransactionsPostBodySourceDefault)
      .describe("Source of transaction creation (manual, import, api, etc.)"),
    isReconciled: zod
      .boolean()
...
export const bulkCreateTransactionsApiV1TransactionsBulkPostBodySourceDefault = `manual`;
...
export const BulkCreateTransactionsApiV1TransactionsBulkPostBodyItem = zod
  .object({
    ...
    source: zod
      ...
      .default(bulkCreateTransactionsApiV1TransactionsBulkPostBodySourceDefault)
      .describe("Source of transaction creation (manual, import, api, etc.)"),
    isReconciled: zod
      .boolean()
      .default(
