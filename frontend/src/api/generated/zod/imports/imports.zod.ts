 ...
 */
export const ImportCsvApiV1ImportsPostBody = zod.unknown();

/**
 * Preview CSV file before importing
 * @summary Preview CSV import
 */
export const PreviewImportApiV1ImportsPreviewPostBody = zod.unknown();

export const PreviewImportApiV1ImportsPreviewPostResponse = zod.object({
  headers: zod.array(zod.string()),
  totalRows: zod.number(),
  previewRows: zod.array(zod.looseObject({})),
  suggestedMapping: zod.looseObject({}),
});
