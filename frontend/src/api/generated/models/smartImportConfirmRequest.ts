 ...
 */
import type { SmartImportConfirmRequestUserOverrides } from "./smartImportConfirmRequestUserOverrides";

/**
 * Request body for POST /api/v1/import/csv/confirm.
 */
export interface SmartImportConfirmRequest {
  jobId: string;
  userOverrides?: SmartImportConfirmRequestUserOverrides;
