...
export interface ImportJobResponse {
  ...
  account_id?: ImportJobResponseAccountId;
  file_name: string;
  import_type: string;
  status: string;
  total_rows?: ImportJobResponseTotalRows;
  processed_rows?: ImportJobResponseProcessedRows;
  successful_imports?: ImportJobResponseSuccessfulImports;
  failed_imports?: ImportJobResponseFailedImports;
  skipped_duplicates?: ImportJobResponseSkippedDuplicates;
  error_message?: ImportJobResponseErrorMessage;
  created_at: string;
  completed_at?: ImportJobResponseCompletedAt;
}
